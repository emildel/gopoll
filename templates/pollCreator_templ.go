...
func PollCreator(title string, answers []string, pollResults []int, pollId string, env string) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = Head("GoPoll | Your Poll").Render(templ.WithChildren(ctx, templ_7745c5c3_Var11), templ_7745c5c3_Buffer)
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		if !templ_7745c5c3_IsBuffer {
...
func openEventConnection(pollId string) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_openEventConnection_20e8`,
		Function: `function __templ_openEventConnection_20e8(pollId){const eventSource = new EventSource("/updateChart/" + pollId + "?stream="+pollId);
    ...
    eventSource.onmessage = (event) => {
		...
		Call:       templ.SafeScript(`__templ_openEventConnection_20e8`, pollId),
		CallInline: templ.SafeScriptInline(`__templ_openEventConnection_20e8`, pollId),
	}
}
...
func loadChart(answers []string, pollResults []int, pollId string) templ.ComponentScript {
	return templ.ComponentScript{
		Name: `__templ_loadChart_8fb5`,
		Function: `function __templ_loadChart_8fb5(answers, pollResults, pollId){var fontSize = 12;
    ...
    var myChart = new Chart("myChart1", {
		...
		Call:       templ.SafeScript(`__templ_loadChart_8fb5`, answers, pollResults, pollId),
		CallInline: templ.SafeScriptInline(`__templ_loadChart_8fb5`, answers, pollResults, pollId),
	}
}
